...
contract WIX is ERC20, Ownable {
    ...
    address payable _marketingWallet = payable(address(0x740310eCF0C55D487ff659305753b085dccE48B5)); // MarketingWallet
    ...
    constructor() ERC20("Wix Protocol", "WIX") {
